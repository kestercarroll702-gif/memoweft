...
- [二、关键数据形状专章（≥30 项）](#二关键数据形状专章30-项)
  - [2.1 三层落库形状（stable）](#21-三层落库形状stable)
  - [2.2 门面各方法入参形状](#22-门面各方法入参形状)
  - [2.3 门面各方法返回形状](#23-门面各方法返回形状)
  - [2.4 管理 API 入出参形状](#24-管理-api-入出参形状)
  - [2.5 便携包形状](#25-便携包形状)
  - [2.6 图谱 payload 形状](#26-图谱-payload-形状)
  - [2.7 感知输入形状](#27-感知输入形状)
  - [2.8 版本 / 配置](#28-版本--配置)
- [三、隐性契约专章（宿主最易踩的坑）](#三隐性契约专章宿主最易踩的坑)
- [四、experimental 清单专章（"以后要变"的集中列出）](#四experimental-清单专章以后要变的集中列出)
- [五、破坏性变更政策（pre-1.0，中间偏松）](#五破坏性变更政策pre-10中间偏松)
  - [5.1 什么算「破坏 stable」](#51-什么算破坏-stable)
  - [5.2 破坏 stable 的三要件](#52-破坏-stable-的三要件)
  - [5.3 枚举加值口径](#53-枚举加值口径)
  - [5.4 experimental 面（松口径）](#54-experimental-面松口径)
