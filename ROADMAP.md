...
- **Phase 5 文档巡检的降级项**(2026-07-11 §18.5 新人视角巡检,5 路 scout 出 ~54 条;本批已修 5 个 HIGH + quick-win,以下结构性/新翻译部分降级):
  ...
  - **internals 导航**:~~给 D-/AD-/Step/Phase 编号一张对照表~~ ✅ 已建(2026-07-13 `docs/internals/numbering-map.md`,Phase/D-xxxx/AD-x/S 四表,零编造,已从 internals/README 入链);~~memory-surface-contract 加可点击 TOC + §II 锚点~~ ✅ 已加(en/zh 各 TOC,additive、正文未动,锚点 GitHub 规则)。剩:`internal/`(私账)vs `internals/`(公开机制)一字之差易混,**评估改名**(判断项,待推荐)。
